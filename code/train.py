...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_config", type=str, default="config/train_20190526fold0.data", help="path to data config file")
    parser.add_argument("--pretrained_weights", type=str, help="if specified starts from checkpoint model")
    parser.add_argument("--n_cpu", type=int, default=8, help="number of cpu threads to use during batch generation")
    parser.add_argument("--img_size", type=int, default=416, help="size of each image dimension")
    parser.add_argument("--name", type=str, default="pollen", help="name of the checkpoint")
    ...
    logger = Logger(os.path.join("logs/",opt.name))
    ...
    # Get dataloader
    print(data_config)
    dataset = ListDataset(train_path, img_size=opt.img_size, augment=True, multiscale=opt.multiscale_training,base_dir=base_dir_path,blur_thres=opt.blur_thres)
    ...
    for epoch in range(opt.epochs):
        ...
        if epoch % opt.checkpoint_interval == 0:
            torch.save(model.state_dict(), f"checkpoints/%s_%d.pth" % (opt.name,epoch))
